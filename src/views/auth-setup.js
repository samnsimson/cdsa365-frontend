        ...
        <div className="felx w-1/4 mx-auto">
          <div className="w-full bg-blueGray-100 p-4 rounded-md shadow-black shadow-sm">
            <div className="p-1 pb-4 justify-center">
              <img src={state?.qrcode ?? ""} alt="qr code" className="m-auto" />
            </div>
            <hr className="-mx-4" />
            ...
            <div className="pt-4 text-center text-md font-normal">
              <p>
                Scan the QR Code with 2-Factor Authentication app like{" "}
                <b>Google Authenticator</b> to setup Authentication and click
                continue
              </p>
              <div className="py-2">
                <input
              ...
              >
                Continue <ArrowNarrowRightIcon className="h-5 w-5 ml-2" />
              </button>
            </div>
          </div>
