...
const ViewTrainer = () => {
    ...
    return (
        <>
            <div className="w-full p-6 bg-gradient-to-r from-teal-600 to-teal-500 space-y-2">
                <div>
                    <p className="font-medium text-white">ID: {trainer.id}</p>
                    <h1 className="font-black text-3xl text-white my-1">
                        {trainer.first_name} {trainer.last_name}
                    </h1>
                    <p className="font-small text-white flex items-center">
                        <AcademicCapIcon
                    ...
                    <div className="trainer-address-section hidden">
                        <div className="text-sm text-white flex items-center">
                            ...
                            <div>
                                ...
                                <p>
                                    {[trainer.city, trainer.district].join(
                                        ', '
                                    )}
                                </p>
                                <p>
                                    {[trainer.state, trainer.pincode].join(
                                        ', '
                                    )}
                                </p>
                            </div>
